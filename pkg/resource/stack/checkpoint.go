...
func DeserializeCheckpoint(ctx context.Context, chkpoint *apitype.CheckpointV3) (*deploy.Snapshot, error) {
	// TODO can we change this function signature or we need to add DeserializeCheckpointWithContext?
